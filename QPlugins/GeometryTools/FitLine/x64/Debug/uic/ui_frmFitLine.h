/********************************************************************************
** Form generated from reading UI file 'frmFitLine.ui'
**
...
#ifndef UI_FRMFITLINE_H
#define UI_FRMFITLINE_H
...
public:
    ...
    void setupUi(QDialog *frmFitLineClass)
    {
        if (frmFitLineClass->objectName().isEmpty())
            frmFitLineClass->setObjectName(QString::fromUtf8("frmFitLineClass"));
        frmFitLineClass->resize(1160, 655);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmFitLineClass->sizePolicy().hasHeightForWidth());
        frmFitLineClass->setSizePolicy(sizePolicy);
        frmFitLineClass->setMinimumSize(QSize(1160, 655));
        frmFitLineClass->setMaximumSize(QSize(1160, 655));
        frmFitLineClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmFitLineClass);
        gridLayout->setSpacing(1);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        tabWidget = new QTabWidget(frmFitLineClass);
...
"		background:url(:/resource/left.png) center no-repeat;}"));
        ...
        label_3 = new QLabel(frmFitLineClass);
        ...
        txtDescribe = new QLineEdit(frmFitLineClass);
        ...
        btnExecute = new QPushButton(frmFitLineClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        retranslateUi(frmFitLineClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmFitLineClass);
    } // setupUi

    void retranslateUi(QDialog *frmFitLineClass)
    {
        frmFitLineClass->setWindowTitle(QCoreApplication::translate("frmFitLineClass", "\346\213\237\345\220\210\347\233\264\347\272\277", nullptr));
        groupCamera->setTitle(QCoreApplication::translate("frmFitLineClass", "\345\233\276\345\203\217\345\257\271\350\261\241", nullptr));
        label_4->setText(QCoreApplication::translate("frmFitLineClass", "\350\276\223\345\205\245\345\233\276\345\203\217\357\274\232", nullptr));
#if QT_CONFIG(tooltip)
        btnLinkImage->setToolTip(QCoreApplication::translate("frmFitLineClass", "\351\223\276\346\216\245\345\233\276\345\203\217", nullptr));
#endif // QT_CONFIG(tooltip)
        btnLinkImage->setText(QString());
#if QT_CONFIG(tooltip)
        btnDelLinkImage->setToolTip(QCoreApplication::translate("frmFitLineClass", "\345\210\240\351\231\244\345\233\276\345\203\217\351\223\276\346\216\245", nullptr));
#endif // QT_CONFIG(tooltip)
        btnDelLinkImage->setText(QString());
        groupC2->setTitle(QCoreApplication::translate("frmFitLineClass", "\346\236\204\345\273\272\345\217\202\346\225\260", nullptr));
        label_5->setText(QCoreApplication::translate("frmFitLineClass", "\350\275\256\345\273\223\347\202\271\351\233\206\357\274\232", nullptr));
#if QT_CONFIG(tooltip)
        btnDelLinkContour->setToolTip(QCoreApplication::translate("frmFitLineClass", "\345\210\240\351\231\244\350\275\256\345\273\223\347\202\271\351\233\206\351\223\276\346\216\245", nullptr));
#endif // QT_CONFIG(tooltip)
        btnDelLinkContour->setText(QString());
#if QT_CONFIG(tooltip)
        btnLinkContour->setToolTip(QCoreApplication::translate("frmFitLineClass", "\351\223\276\346\216\245\350\275\256\345\273\223\347\202\271\351\233\206", nullptr));
#endif // QT_CONFIG(tooltip)
        btnLinkContour->setText(QString());
#if QT_CONFIG(tooltip)
        txtLinkContour->setToolTip(QCoreApplication::translate("frmFitLineClass", "vector<cv::Point2f>\347\261\273\345\236\213", nullptr));
#endif // QT_CONFIG(tooltip)
        groupC3->setTitle(QCoreApplication::translate("frmFitLineClass", "\350\276\223\345\207\272\346\225\260\346\215\256(\347\233\264\347\272\277\347\232\204\346\226\234\347\216\207\343\200\201\346\210\252\350\267\235)", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("frmFitLineClass", "\345\237\272\346\234\254\350\256\276\347\275\256", nullptr));
        label_3->setText(QCoreApplication::translate("frmFitLineClass", "\345\215\225\345\205\203\346\217\217\350\277\260\357\274\232", nullptr));
        btnExecute->setText(QCoreApplication::translate("frmFitLineClass", "\346\211\247\350\241\214", nullptr));
    } // retranslateUi

};

namespace Ui {
    class frmFitLineClass: public Ui_frmFitLineClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMFITLINE_H
