...
#include <QDialog>
#include "ui_frmFitLine.h"
#include <opencv2\opencv.hpp>
#include "mytitlebar.h"
#include "QGraphicsViews.h"
#include "Toolnterface.h"

class frmFitLine : public Toolnterface
{
	Q_OBJECT

public:
	frmFitLine(QString toolName, QToolBase* toolBase, QWidget* parent = Q_NULLPTR);
	~frmFitLine();

private:
	Ui::frmFitLineClass ui;
