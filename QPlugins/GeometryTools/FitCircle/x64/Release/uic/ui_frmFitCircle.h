...
#ifndef UI_FRMFITCIRCLE_H
#define UI_FRMFITCIRCLE_H
...
public:
    ...
    void setupUi(QDialog *frmFitCircleClass)
    {
        if (frmFitCircleClass->objectName().isEmpty())
            frmFitCircleClass->setObjectName(QString::fromUtf8("frmFitCircleClass"));
        frmFitCircleClass->resize(1160, 655);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmFitCircleClass->sizePolicy().hasHeightForWidth());
        frmFitCircleClass->setSizePolicy(sizePolicy);
        frmFitCircleClass->setMinimumSize(QSize(1160, 655));
        frmFitCircleClass->setMaximumSize(QSize(1160, 655));
        frmFitCircleClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmFitCircleClass);
        gridLayout->setSpacing(1);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        tabWidget = new QTabWidget(frmFitCircleClass);
...
"		background:url(:/resource/left.png) center no-repeat;}"));
        ...
        label_3 = new QLabel(frmFitCircleClass);
        ...
        txtDescribe = new QLineEdit(frmFitCircleClass);
        ...
        btnExecute = new QPushButton(frmFitCircleClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        retranslateUi(frmFitCircleClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmFitCircleClass);
    } // setupUi
...
namespace Ui {
    class frmFitCircleClass: public Ui_frmFitCircleClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMFITCIRCLE_H
