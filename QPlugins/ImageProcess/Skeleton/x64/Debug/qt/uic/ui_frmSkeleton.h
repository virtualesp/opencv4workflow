...
#ifndef UI_FRMSKELETON_H
#define UI_FRMSKELETON_H
...
public:
    ...
    void setupUi(QDialog *frmSkeletonClass)
    {
        if (frmSkeletonClass->objectName().isEmpty())
            frmSkeletonClass->setObjectName(QString::fromUtf8("frmSkeletonClass"));
        frmSkeletonClass->resize(1160, 655);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmSkeletonClass->sizePolicy().hasHeightForWidth());
        frmSkeletonClass->setSizePolicy(sizePolicy);
        frmSkeletonClass->setMinimumSize(QSize(1160, 655));
        frmSkeletonClass->setMaximumSize(QSize(1160, 655));
        frmSkeletonClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmSkeletonClass);
        ...
        tabWidget = new QTabWidget(frmSkeletonClass);
...
"color: rgb(85, 0, 255);"));
        spinIterateNum = new QSpinBox(groupCamera_2);
        spinIterateNum->setObjectName(QString::fromUtf8("spinIterateNum"));
        spinIterateNum->setGeometry(QRect(100, 38, 100, 27));
        QFont font1;
        font1.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        font1.setPointSize(11);
        spinIterateNum->setFont(font1);
        spinIterateNum->setStyleSheet(QString::fromUtf8("QWidget{color: rgb(85, 0, 155);background-color: rgb(180, 180, 210);}\n"
"QSpinBox::up-button{\n"
"    border:transparent;\n"
"}\n"
...
"}"));
        spinIterateNum->setAlignment(Qt::AlignCenter);
        spinIterateNum->setMinimum(0);
        spinIterateNum->setMaximum(100);
        spinIterateNum->setValue(25);
        label_5 = new QLabel(groupCamera_2);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(13, 41, 79, 19));
        QFont font2;
...
"background: transparent;"));
        ...
        groupCamera_8->setGeometry(QRect(9, 18, 427, 73));
...
"QPushButton:pressed{background-color: rgb(117, 83, 96);}"));
        ...
        label_3 = new QLabel(frmSkeletonClass);
        ...
        txtDescribe = new QLineEdit(frmSkeletonClass);
        ...
        btnExecute = new QPushButton(frmSkeletonClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        retranslateUi(frmSkeletonClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmSkeletonClass);
    } // setupUi
...
namespace Ui {
    class frmSkeletonClass: public Ui_frmSkeletonClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMSKELETON_H
