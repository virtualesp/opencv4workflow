...
#include <QDialog>
#include "ui_frmImageRotate.h"
#include <opencv2\opencv.hpp>
#include "mytitlebar.h"
#include "QGraphicsViews.h"
#include "Toolnterface.h"

class frmImageRotate : public Toolnterface
{
	Q_OBJECT

public:
	frmImageRotate(QString toolName, QToolBase* toolBase, QWidget* parent = Q_NULLPTR);
	~frmImageRotate();

private:
	Ui::frmImageRotateClass ui;
...
private:
	...
	bool ImgRotate(const cv::Mat src, const float angle, cv::Mat& out_dst);
