...
#ifndef UI_FRMIMAGEROTATE_H
#define UI_FRMIMAGEROTATE_H
...
public:
    ...
    void setupUi(QDialog *frmImageRotateClass)
    {
        if (frmImageRotateClass->objectName().isEmpty())
            frmImageRotateClass->setObjectName(QString::fromUtf8("frmImageRotateClass"));
        frmImageRotateClass->resize(1160, 655);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmImageRotateClass->sizePolicy().hasHeightForWidth());
        frmImageRotateClass->setSizePolicy(sizePolicy);
        frmImageRotateClass->setMinimumSize(QSize(1160, 655));
        frmImageRotateClass->setMaximumSize(QSize(1160, 655));
        frmImageRotateClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmImageRotateClass);
        ...
        tabWidget = new QTabWidget(frmImageRotateClass);
...
"QPushButton:pressed{background-color: rgba(226, 172, 162, 200);}"));
        ...
        groupCamera_2->setGeometry(QRect(9, 108, 427, 73));
...
"background: transparent;"));
        spinRotate = new QDoubleSpinBox(groupCamera_2);
        spinRotate->setObjectName(QString::fromUtf8("spinRotate"));
        spinRotate->setGeometry(QRect(100, 38, 100, 27));
        QFont font2;
        font2.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        font2.setPointSize(11);
        spinRotate->setFont(font2);
        spinRotate->setStyleSheet(QString::fromUtf8("QWidget{color: rgb(85, 0, 155);background-color: rgb(180, 180, 210);}\n"
...
"}"));
        spinRotate->setAlignment(Qt::AlignCenter);
        spinRotate->setDecimals(1);
        spinRotate->setMinimum(-180.000000000000000);
        spinRotate->setMaximum(180.000000000000000);
        spinRotate->setSingleStep(0.100000000000000);
        spinRotate->setValue(25.000000000000000);
        ...
        label_3 = new QLabel(frmImageRotateClass);
        ...
        txtDescribe = new QLineEdit(frmImageRotateClass);
        ...
        btnExecute = new QPushButton(frmImageRotateClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        retranslateUi(frmImageRotateClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmImageRotateClass);
    } // setupUi
...
namespace Ui {
    class frmImageRotateClass: public Ui_frmImageRotateClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMIMAGEROTATE_H
