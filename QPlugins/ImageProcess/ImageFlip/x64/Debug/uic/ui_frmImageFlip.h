...
#ifndef UI_FRMIMAGEFLIP_H
#define UI_FRMIMAGEFLIP_H
...
public:
    ...
    void setupUi(QDialog *frmImageFlipClass)
    {
        if (frmImageFlipClass->objectName().isEmpty())
            frmImageFlipClass->setObjectName(QString::fromUtf8("frmImageFlipClass"));
        frmImageFlipClass->resize(1160, 655);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmImageFlipClass->sizePolicy().hasHeightForWidth());
        frmImageFlipClass->setSizePolicy(sizePolicy);
        frmImageFlipClass->setMinimumSize(QSize(1160, 655));
        frmImageFlipClass->setMaximumSize(QSize(1160, 655));
        frmImageFlipClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmImageFlipClass);
        ...
        tabWidget = new QTabWidget(frmImageFlipClass);
...
"color: rgb(85, 0, 255);"));
        ...
        label_5->setGeometry(QRect(13, 40, 79, 19));
        QFont font1;
...
"background: transparent;"));
        comboFlip = new QComboBox(groupCamera_2);
        comboFlip->addItem(QString());
        comboFlip->addItem(QString());
        comboFlip->addItem(QString());
        comboFlip->addItem(QString());
        comboFlip->setObjectName(QString::fromUtf8("comboFlip"));
        comboFlip->setGeometry(QRect(100, 35, 160, 30));
        sizePolicy.setHeightForWidth(comboFlip->sizePolicy().hasHeightForWidth());
        comboFlip->setSizePolicy(sizePolicy);
        comboFlip->setMinimumSize(QSize(145, 30));
        comboFlip->setMaximumSize(QSize(16777215, 16777215));
        comboFlip->setFont(font);
        comboFlip->setStyleSheet(QString::fromUtf8("QComboBox {\n"
...
"}"));
        ...
        label_3 = new QLabel(frmImageFlipClass);
        ...
        txtDescribe = new QLineEdit(frmImageFlipClass);
        ...
        btnExecute = new QPushButton(frmImageFlipClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        retranslateUi(frmImageFlipClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmImageFlipClass);
    } // setupUi
...
namespace Ui {
    class frmImageFlipClass: public Ui_frmImageFlipClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMIMAGEFLIP_H
