...
QT_INIT_METAOBJECT const QMetaObject ScriptEdit::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ScriptEdit.data,
    qt_meta_data_ScriptEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    'e',  'r',  'f',  'a',  'c',  'e', 
    // "className"
    0x03,  0x6a,  'S',  'c',  'r',  'i',  'p',  't', 
    'E',  'd',  'i',  't', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(ScriptEdit, ScriptEdit)
