...
#include <QDialog>
#include "ui_frmLogicJudge.h"
#include "mytitlebar.h"
#include "Toolnterface.h"

class frmLogicJudge : public Toolnterface
{
	Q_OBJECT

public:
	frmLogicJudge(QString toolName, QToolBase* toolBase, QWidget* parent = Q_NULLPTR);
	~frmLogicJudge();

private:
	Ui::frmLogicJudgeClass ui;
