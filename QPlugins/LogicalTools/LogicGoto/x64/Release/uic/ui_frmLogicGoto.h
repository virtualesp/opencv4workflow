...
#ifndef UI_FRMLOGICGOTO_H
#define UI_FRMLOGICGOTO_H
...
public:
    ...
    QLabel *lblMsg;
    QLabel *label_8;
    QComboBox *comboToolName;
    QPushButton *btnUpdata;

    void setupUi(QDialog *frmLogicGotoClass)
    {
        if (frmLogicGotoClass->objectName().isEmpty())
            frmLogicGotoClass->setObjectName(QString::fromUtf8("frmLogicGotoClass"));
        frmLogicGotoClass->resize(610, 408);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frmLogicGotoClass->sizePolicy().hasHeightForWidth());
        frmLogicGotoClass->setSizePolicy(sizePolicy);
        frmLogicGotoClass->setMinimumSize(QSize(610, 408));
        frmLogicGotoClass->setMaximumSize(QSize(610, 408));
        frmLogicGotoClass->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        gridLayout = new QGridLayout(frmLogicGotoClass);
        ...
        label_3 = new QLabel(frmLogicGotoClass);
        ...
        txtDescribe = new QLineEdit(frmLogicGotoClass);
        ...
        btnExecute = new QPushButton(frmLogicGotoClass);
...
"QPushButton:pressed{background-color: rgb(85, 175, 127);}"));
        ...
        tabWidget = new QTabWidget(frmLogicGotoClass);
        ...
        groupC->setGeometry(QRect(9, 14, 587, 258));
        groupC->setFont(font);
...
"background-color: rgba(0, 0, 0, 0);"));
        ...
        groupC2->setGeometry(QRect(6, 70, 574, 63));
...
"color: rgb(0, 0, 127);"));
        ...
        btnDelLinkBool->setGeometry(QRect(540, 28, 27, 27));
...
"QPushButton:pressed{background-color: rgba(226, 172, 162, 200);}"));
        ...
        btnLinkBool->setGeometry(QRect(508, 28, 27, 27));
...
"QPushButton:pressed{background-color: rgba(85, 180, 127, 160);}"));
        ...
        label_5->setGeometry(QRect(411, 30, 16, 19));
        QFont font1;
...
"background-color: rgba(0, 0, 0, 0);"));
        lbl_goto = new QLabel(groupC2);
        lbl_goto->setObjectName(QString::fromUtf8("lbl_goto"));
        lbl_goto->setGeometry(QRect(4, 32, 119, 19));
        lbl_goto->setFont(font);
        lbl_goto->setStyleSheet(QString::fromUtf8("color: rgb(30, 30, 30);\n"
"background-color: rgba(0, 0, 0, 0);"));
        txtLinkBool = new QLineEdit(groupC2);
        txtLinkBool->setObjectName(QString::fromUtf8("txtLinkBool"));
        txtLinkBool->setGeometry(QRect(121, 28, 286, 28));
...
"background-color: rgba(170, 170, 127,50);"));
        ...
        comboBool->setGeometry(QRect(429, 28, 70, 28));
...
"}"));
        ...
        groupC3->setGeometry(QRect(6, 136, 574, 63));
...
"color: rgb(0, 0, 127);"));
        ...
        btnDelLinkRegex->setGeometry(QRect(540, 28, 27, 27));
...
"QPushButton:pressed{background-color: rgba(226, 172, 162, 200);}"));
        ...
        btnLinkRegex->setGeometry(QRect(508, 28, 27, 27));
...
"background-color: rgba(0, 0, 0, 0);"));
        ...
        txtLinkRegex->setGeometry(QRect(100, 28, 243, 28));
...
"background-color: rgba(170, 170, 127,50);"));
        ...
        comboRegex->setGeometry(QRect(350, 28, 55, 28));
...
"}"));
        ...
        spinRegex->setGeometry(QRect(413, 28, 87, 28));
...
"background-color: rgba(0, 0, 0, 0);"));
        ...
        label_8->setGeometry(QRect(17, 225, 99, 19));
        label_8->setFont(font);
        label_8->setStyleSheet(QString::fromUtf8("color: rgb(30, 30, 30);\n"
"background-color: rgba(0, 0, 0, 0);"));
        comboToolName = new QComboBox(groupC);
        comboToolName->setObjectName(QString::fromUtf8("comboToolName"));
        comboToolName->setGeometry(QRect(114, 222, 233, 27));
        comboToolName->setFont(font);
        comboToolName->setStyleSheet(QString::fromUtf8("QComboBox {\n"
"    border: 1px solid gray;\n"
"    border-radius: 2px;    \n"
"    color: rgb(0, 0, 200);\n"
"	background-color: rgba(170, 170, 127,100);\n"
...
"}"));
        ...
        btnUpdata->setGeometry(QRect(355, 221, 85, 30));
...
"QPushButton:pressed{background-color: rgb(9, 82, 72);}"));
        ...
        retranslateUi(frmLogicGotoClass);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(frmLogicGotoClass);
    } // setupUi
...
namespace Ui {
    class frmLogicGotoClass: public Ui_frmLogicGotoClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FRMLOGICGOTO_H
