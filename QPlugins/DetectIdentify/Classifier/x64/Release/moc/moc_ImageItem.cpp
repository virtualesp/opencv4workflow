...
QT_MOC_LITERAL(4, 28, 15), // "ClassifierValue"
QT_MOC_LITERAL(5, 44, 20) // "slot_ClassifierValue"

    },
    "ImageItem\0RGBValue\0\0InfoVal\0ClassifierValue\0"
    "slot_ClassifierValue"
};
...
void ImageItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ClassifierValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->slot_ClassifierValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ImageItem::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageItem::ClassifierValue)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ImageItem::ClassifierValue(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
