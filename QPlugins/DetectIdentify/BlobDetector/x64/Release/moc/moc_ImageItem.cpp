...
QT_MOC_LITERAL(4, 28, 9), // "BlobValue"
QT_MOC_LITERAL(5, 38, 14) // "slot_BlobValue"

    },
    "ImageItem\0RGBValue\0\0InfoVal\0BlobValue\0"
    "slot_BlobValue"
};
...
void ImageItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->BlobValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->slot_BlobValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ImageItem::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageItem::BlobValue)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ImageItem::BlobValue(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
